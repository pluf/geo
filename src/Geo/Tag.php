 ...
 *
 */
class Geo_Tag extends Pluf_Model
{
    ...
    function init()
    {
        $this->_a['table'] = 'geo_tag';
        $this->_a['model'] = 'Geo_Tag';
        $this->_model = 'Geo_Tag';
        $this->_a['cols'] = array(
            'id' => array(
        ...
        $this->_a['views'] = array(
            'join_row' => array(
                'select' => $this->getSelect() . ',' . $this->_con->pfx . 'geo_tagrow.owner_class as owner_class' . ',' . $this->_con->pfx . 'geo_tagrow.owner_id as owner_id',
                'props' => array(
                    'owner_class' => 'owner_class',
                    'owner_id' => 'owner_id'
                ),
                'join' => 'LEFT JOIN ' . $this->_con->pfx . 'geo_tagrow ON geo_tagrow.tag=' . $this->_con->pfx . 'geo_tag.id'
            )
        );
    }
