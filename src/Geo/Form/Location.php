...
Pluf::loadFunction('Geo_Shortcuts_locationFactory');

/**
 * فرم به روز رسانی اطلاعات کاربر را ایجاد می‌کند.
 */
class Geo_Form_Location extends Pluf_Form
{
    ...
    public function initFields ($extra = array())
    {
        ...
        $this->location = Geo_Shortcuts_locationFactory($this->location);
    ...
    function save ($commit = true)
    {
        ...
        $this->location->tenant = $this->tenant;
        if ($commit) {
